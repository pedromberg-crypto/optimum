...
export const seedDB: DB = {
  ...
  cargos: [
    ...
    { id: 'k14', fam: 'f4', nivel: 'III', n: 'Gestora de Pessoas', desc: 'Lidera o time de RH, define estratégia de pessoas, conduz ciclos de avaliação e PDI, interface com CEO.', piso: 7500, alvo: 10000, teto: 14000, req: 'Gestão de equipe, OKR, business partnering, liderança', prog: 'Cargo de chegada da trilha de gestão em RH', track: 'gest' },
  ...
  salHist: [],
  sindicatos: [
    { id: 'sd1', nome: 'SINDADOS (Sind. dos Profissionais de Processamento de Dados)', sigla: 'SINDADOS', dataBase: '09-01', abrangeAreas: ['Engenharia e Produto', 'Dados e Inteligência'], historico: [{ ano: 2024, perc: 5.5, dataAplicacao: '2024-09-15', obs: 'Convenção 2024/2025' }], obs: 'Reajuste anual em setembro. Acompanhar publicação no MTE.' },
    { id: 'sd2', nome: 'SINDIFOR (Sind. das Empresas de Informática)', sigla: 'SINDIFOR', dataBase: '01-01', abrangeAreas: ['Comercial e Suporte', 'Financeiro / Adm', 'Gente & Gestão (RH)'], historico: [{ ano: 2024, perc: 4.8, dataAplicacao: '2024-01-20', obs: 'Convenção 2024/2025' }], obs: 'Reajuste em janeiro. Cobre empresas de informática.' },
  ],
  requisitos: [],
  prontidao: {},
  regras: {
